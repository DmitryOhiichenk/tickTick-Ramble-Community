...
enum L: CaseIterable {
    ...
    var translations: [String] {
        ...
        case .beta: return ["Beta. Check your tasks before sending", "Бета-версія. Перевірте завдання перед надсиланням", "Бета-версия. Проверьте задачи перед отправкой", "Beta. Revisa las tareas antes de enviarlas", "Wersja beta. Sprawdź zadania przed wysłaniem", "Beta. Prüfe die Aufgaben vor dem Senden", "Beta. Controlla le attività prima dell'invio"]
        ...
        case .menuOpen: return ["Open Dictate for TickTick", "Відкрити Dictate for TickTick", "Открыть Dictate for TickTick", "Abrir Dictate for TickTick", "Otwórz Dictate for TickTick", "Dictate for TickTick öffnen", "Apri Dictate for TickTick"]
        ...
        case .menuQuit: return ["Quit Dictate for TickTick", "Вийти з Dictate for TickTick", "Завершить Dictate for TickTick", "Salir de Dictate for TickTick", "Zakończ Dictate for TickTick", "Dictate for TickTick beenden", "Esci da Dictate for TickTick"]
        case .menuAbout: return ["About Dictate for TickTick", "Про Dictate for TickTick", "О программе Dictate for TickTick", "Acerca de Dictate for TickTick", "O Dictate for TickTick", "Über Dictate for TickTick", "Informazioni su Dictate for TickTick"]
        case .menuHide: return ["Hide Dictate for TickTick", "Сховати Dictate for TickTick", "Скрыть Dictate for TickTick", "Ocultar Dictate for TickTick", "Ukryj Dictate for TickTick", "Dictate for TickTick ausblenden", "Nascondi Dictate for TickTick"]
